...
const app = {
    jumpTo: ({ ref }) => {
        ...
        scroll
            ...
            .then(renderNext)
            .then((pageNode) => {
            const lines = [...pageNode.querySelectorAll('.line')];
...
const renderPage = ({ insertStrategy: insert, }) => ({ content, title, pageNumber, }) => {
...
document.addEventListener('DOMContentLoaded', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    document.addEventListener('keydown', whenKey('!', () => {
    ...
    toggle.addEventListener('change', () => toggleAnnotations(() => !toggle.checked));
    ...
    document.addEventListener('keydown', whenKey('Escape', (e) => {
        if (isShowingParshaPicker()) {
            e.preventDefault();
            hideParshaPicker();
        }
    }));
    const startingRef = yield urlToRef({
