...
test.only(`converts ktiv & kri for multiple on the same line`, (t) => {
    const multiKtivKri = 'הָעַמִּ֑ים וְלִהְי֨וֹת היהודיים#[הַיְּהוּדִ֤ים] עתודים#[עֲתִידִים֙] לַיּ֣וֹם הַזֶּ֔ה לְהִנָּקֵ֖ם';
    const actual = textFilter({
        text: multiKtivKri,
        annotated: true,
    });
    t.log(actual);
    t.is(actual, 'הָעַמִּ֑ים וְלִהְי֨וֹת {הַיְּהוּדִ֤ים} {עֲתִידִים֙} לַיּ֣וֹם הַזֶּ֔ה לְהִנָּקֵ֖ם');
    t.is(textFilter({ text: multiKtivKri, annotated: false }), 'העמים ולהיות היהודיים עתודים ליום הזה להנקם');
});
//# sourceMappingURL=text-filter.test.js.map