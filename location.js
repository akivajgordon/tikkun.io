...
const toc = tocJSON;
const tocFromScroll = Object.assign({ torah: toc, esther: estherToc }, holydaysToc);
...
export const physicalLocationFromRef = ({ ref: { b: book, c: chapter, v: verse }, scroll, }) => {
    const { p: pageNumber, l: lineNumber } = tocFromScroll[scroll][book][chapter][verse];
    return { pageNumber, lineNumber };
};
export const resolveToValidRef = ({ scroll = 'torah', book, chapter, verse, }) => {
    ...
    return Object.assign({ scroll }, ref);
};
